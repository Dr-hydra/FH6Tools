...
Public Class FormMain
    ...
    Public Sub UpdateShellStatus(gameText As String, toolText As String)
        PageNav?.UpdateStatus(PageMain?.GameSummary, toolText,
                              PageMain IsNot Nothing AndAlso PageMain.IsGameInstalled,
                              PageMain IsNot Nothing AndAlso PageMain.IsGameRunning)
    End Sub
