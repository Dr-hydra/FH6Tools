...
' I hereby re-license this file under the Apache License 2.0 for use in the adapted launcher frontend project.
'
' This file is contributed under the spirit of good faith and open cooperation.
' It does not implement any core launcher functions.
'
' Description:
