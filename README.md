...
| 工具 | 简介 | 项目地址 |
| --- | --- | --- |
| OmniMix VB.NET Frontend | 可以自定义的《地平线 6》音乐电台，支持网易云音乐、QQ 音乐和哔哩哔哩歌曲导入。 | [Dr-hydra/OmniMix-VBNet-Frontend](https://github.com/Dr-hydra/OmniMix-VBNet-Frontend) |
...
| Forza Painter FH6 | 将图片转换为 FH6 涂装绘制数据，并提供可配置的几何参数。 | [bvzrays/forza-painter-fh6](https://github.com/bvzrays/forza-painter-fh6) |
...
项目维护者认可的候选工具来源记录在 [tools.md](tools.md)。FH6Tools 会在启动时动态更新可用工具清单，并允许用户添加本地工具。
