...
#Region "自定义属性"
    ...
    Public Property Logo As String
        ...
        Set(value As String)
            ...
            End If
            '改变行距
            ColumnLogo.Width = New GridLength(GetLogoColumnWidth())
        End Set
    End Property
    Private _LogoWidth As Double = -1
    Public Property LogoWidth As Double
        ...
        End Set
    End Property
    Private Function GetLogoColumnWidth() As Double
        If _Logo = "" Then Return 0
        If _LogoWidth > 0 Then Return _LogoWidth
        Return 34 + If(Height < 40, 0, 4)
    End Function
    ...
    Private Sub OnSizeChanged() Handles Me.SizeChanged
        ...
        If PathLogo IsNot Nothing Then
            ...
            ElseIf _Logo.StartsWithF("http", True) Then
                PathLogo.Margin = New Thickness(4, 5, 4, 5)
            Else
...
#End Region
        ...
        If IsLoaded AndAlso AniControlEnabled = 0 Then '防止默认属性变更触发动画
            ...
            If IsMouseOver AndAlso IsMouseOverAnimationEnabled Then
                ...
                If IsScaleAnimationEnabled Then
                    Dim RectBackScale = EnsureScaleTransform(RectBack)
                    Dim SelfScale = EnsureScaleTransform(Me)
                    Ani.Add(AaScaleTransform(RectBack, 1 - RectBackScale.ScaleX, Time * 1.6,, New AniEaseOutFluent))
                    If IsMouseDown Then
                        Ani.Add(AaScaleTransform(Me, 0.98 - SelfScale.ScaleX, Time * 0.9,, New AniEaseOutFluent))
                    Else
                        Ani.Add(AaScaleTransform(Me, 1 - SelfScale.ScaleX, Time * 1.2,, New AniEaseOutFluent))
                    End If
                End If
            Else
                If ButtonStack IsNot Nothing Then
                ...
                If IsScaleAnimationEnabled Then
                    ...
                    Ani.AddRange({
                        ...
                        AaScaleTransform(Me, 1 - SelfScale.ScaleX, Time * 3,, New AniEaseOutFluent),
                        AaScaleTransform(RectBack, 0.996 - RectBackScale.ScaleX, Time,, New AniEaseOutFluent),
    ...
    Private Sub MyListItem_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        End If
        ColumnPaddingRight.Width = New GridLength(MinPaddingRight)
        If CustomEventService.GetEventType(Me) = CustomEvent.EventType.打开帮助 Then
            CustomEventService.SetEventType(Me, CustomEvent.EventType.None)
            CustomEventService.SetEventData(Me, "")
        End If
    End Sub

    Private Shared Function EnsureScaleTransform(element As FrameworkElement) As ScaleTransform
        If TypeOf element.RenderTransform Is ScaleTransform Then Return DirectCast(element.RenderTransform, ScaleTransform)
