Public Class MyScrollViewer
    ...
    Private Sub MyScrollViewer_ScrollChanged(sender As Object, e As ScrollChangedEventArgs) Handles Me.ScrollChanged
        ...
        If FrmMain IsNot Nothing AndAlso FrmMain.BtnExtraBack IsNot Nothing AndAlso (e.VerticalChange OrElse e.ViewportHeightChange) Then FrmMain.BtnExtraBack.ShowRefresh()
    End Sub
    Private Sub MyScrollViewer_IsVisibleChanged(sender As Object, e As DependencyPropertyChangedEventArgs) Handles Me.IsVisibleChanged
        If FrmMain IsNot Nothing AndAlso FrmMain.BtnExtraBack IsNot Nothing Then FrmMain.BtnExtraBack.ShowRefresh()
    End Sub
